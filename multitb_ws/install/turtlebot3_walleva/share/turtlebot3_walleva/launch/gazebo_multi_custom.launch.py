...
def generate_launch_description():
    ...
    turtlebot3_walleva = get_package_share_directory('turtlebot3_walleva')
    ...
    # urdf = os.path.join(
    #     turtlebot3_walleva, 'urdf', 'turtlebot3_' + TURTLEBOT3_MODEL + '.urdf'
    # )
    ...
    for robot in robots:
        ...
        spawn_turtlebot3_waffle = Node(
            ...
            arguments=[
                '-file', os.path.join(turtlebot3_walleva, 'models', robot['urdf_model'], 'model.sdf'),
                #'-file', os.path.join(turtlebot3_walleva,'models', 'turtlebot3_' + TURTLEBOT3_MODEL, 'model.sdf'),
                '-entity', robot['name'],
    ...
    for robot in robots:
        ...
        rviz_cmd = IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                ...
                launch_arguments={
                    ...
                    'log_level': 'warn',
                    # 'message_filter_queue_size': 200,  # Set the queue size here
        ...
        # Add message_filter_queue_size parameter
        # rviz_node = Node(
        #         package='rviz2',
        #         executable='rviz2',
        #         namespace=namespace,
        ...
        #         parameters=[
        #             {'use_sim_time': use_sim_time},
        #             {'message_filter_queue_size': 100},  # Set the queue size here
        #         ],
