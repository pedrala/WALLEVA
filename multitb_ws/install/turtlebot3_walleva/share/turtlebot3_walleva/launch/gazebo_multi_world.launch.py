...
def generate_launch_description():
    ...
    launch_file_dir = os.path.join(turtlebot3_walleva, "launch")

    world = os.path.join(
        turtlebot3_walleva, "worlds", "multi_empty_world.world"
    )
    ...
    urdf = os.path.join(
        turtlebot3_walleva, "urdf", urdf_file_name
    )
    ...
    for i in range(COLS):
        ...
        for j in range(ROWS):
            ...
            spawn_turtlebot3_burger = Node(
                ...
                arguments=[
                    "-file",
                    os.path.join(turtlebot3_walleva,'models', 'turtlebot3_' + TURTLEBOT3_MODEL, 'model.sdf'),
                    "-entity",
                    name,
                    "-robot_namespace",
                    namespace,
